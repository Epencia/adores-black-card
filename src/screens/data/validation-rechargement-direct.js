...
export default function RechargementDirect({route,navigation})  {
  ...
  const handlePress = async () => {
    ...
    const url = `https://adores.tech/api/carte/rechargement-mobile-money.php?countryCurrencyCode=${item.code_pays}&amount=${montant}&customerId=${user[0].matricule}&channel=${item.id}&customerEmail=info@adores.tech&customerFirstName=${user[0].nom_prenom}&customerLastname=&customerPhoneNumber=${telephone}&referenceNumber=1234567890`;
