...
export default function DeclarationObjet({ navigation, route }) {
  ...
  useEffect(() => {
    navigation.setOptions({ title: "Déclaration d'un appareil"});
  }, []);
  ...
  const ValidationObjet = () => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      fetch('https://adores.tech/api/carte/declaration-objet.php',{
        method:'post',
        header:{
